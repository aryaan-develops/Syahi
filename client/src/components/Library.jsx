                                ...
                                {loading ? (
                                    ...
                                    blogList.map(item => (
                                        <div key={item._id} className="library-card blog-card">
                                            ...
                                            <span className="author" style={{ textAlign: 'left' }}>By {item.authorName}</span>
                                            <button className="btn-vintage-text" onClick={() => alert(item.content)}>Read Full Scroll...</button>
                                        </div>
                                    ))
                                ) : (
